...
def display():
	...
	text2.insert(INSERT, str(ait.now))#Seconds elapsed
	text2.insert(INSERT, '\n')
	text2.insert(INSERT, 'Active Neurons: ')
	text2.insert(INSERT, str(ait.currentlyActiveNeurons))
	text2.insert(INSERT, '\n')
	text2.insert(INSERT, 'Top Of The Chain List: ')
	text2.insert(INSERT, str(ait.topOfTheChainList))
	text2.insert(INSERT, '\n')

	#text2.insert(INSERT, ait.neuronList[4].get())
...
def brainActive(): #activates the mainBrainMethod in ait.py
	ait.mainBrainMethod()
